...
exports.minVersion = (req, res) => {
    ...
    res.end(JSON.stringify({ "Android": minAndriodVersion, "iOS": minIOSVersion}));
    res.status(200);
};
...
exports.minVersionWithOutageMessage = (req, res) => {
    res.setHeader('Content-Type', 'application/json');
    res.end(JSON.stringify({ "Android": minAndriodVersion, "iOS": minIOSVersion,  "outageMessage": "We are out of action until 10pm AEST, please try again later" }));
    res.status(200);
};
